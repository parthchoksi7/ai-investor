...
Confirm that the cloud routine (Routine ID: `YOUR_ROUTINE_ID_DAILY`) contains:
- `POLYGON_API_KEY` (embedded in prompt)
- Robinhood MCP connector (`YOUR_MCP_CONNECTOR_UUID`)
...
1. Navigate to: https://claude.ai/code/routines/YOUR_ROUTINE_ID_DAILY
...
1. Open https://claude.ai/code/routines/YOUR_ROUTINE_ID_DAILY
