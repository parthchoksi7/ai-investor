...
forward-tested via the prediction ledger, never backtested. See archive/FINAL_PLAN.md
(historical design rationale) and calibration.py (the live forward-test harness).
"""
